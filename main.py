...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(50, HEIGHT - 150), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(50, WIDTH - 100), 0, *bonus_size)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOR_BLACK), (30, 30))
